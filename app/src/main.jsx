...
// Only show error overlay for true crashes, not background promise rejections
window.onerror = function(msg, src, line, col, err) {
  // Ignore minor errors
  if (!msg || msg === 'Script error.' || msg.includes('ResizeObserver')) return;
  console.error('App error:', msg, src, line);
  // Only replace page for critical errors
  if (msg.includes('is not defined') || msg.includes('Cannot read') || msg.includes('undefined is not')) {
